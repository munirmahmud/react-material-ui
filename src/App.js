    ...
    return (
        <ThemeProvider theme={theme}>
            ...
            <Switch>
                ...
                <Route exact path="/custom-software" component={() => <h2>Software</h2>} />
                <Route exact path="/mobile-apps" component={() => <h2>Mobile Apps</h2>} />
                <Route exact path="/websites" component={() => <h2>Websites</h2>} />
                <Route exact path="/revolution" component={() => <h2>The Revolution</h2>} />
